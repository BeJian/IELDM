import numpy as np
from IELDiffusion.utils.diffusion import VPSDE
import xgboost as xgb


# Build the dataset of x(t) at multiple values of t
# x0噪声  x1真实样本  噪声数据（x0）到目标数据（x1）的扩散过程
def build_data_xt(x0, x1, x_covs=None, n_t=101, diffusion_type='vp', eps=1e-3, sde=None):
  b, c = x1.shape
